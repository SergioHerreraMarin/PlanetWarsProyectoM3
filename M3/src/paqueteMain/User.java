...
//		this.birth_date = date;
	...
	public String[] getPlanetasListado(Connection con, int totalPlanets) {
		...
		String query = "SELECT planet_name FROM planets where user_name = " + getUser_name() +";";
		ResultSet rs = null;
	...
	public void crearPlaneta(Connection con, int new_id_user) {
		...
		//NUEVO id_planet
		rs = DB_utils.SelectQuery(con, "SELECT max(id_planet)+1 FROM planets;");
		...
		stmnt.setString(2, nombreNuevoPlaneta);
		stmnt.setInt(3, nuevoTechAttack);
		stmnt.setInt(4, nuevaTechDefense);
		stmnt.setInt(5, nuevoTechAttackUpgradeCost);
		stmnt.setInt(6, nuevoTechDefenseUpgradeCost);
		stmnt.setInt(7, nuevoDeuterium);
		stmnt.setInt(8, nuevoMetal);
		stmnt.setInt(9, nuevoCrystal);
		stmnt.setInt(10, new_id_user);
