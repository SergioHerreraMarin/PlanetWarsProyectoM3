...
public class Battle {
	...
	private ArrayList<MilitaryUnit>[][] armies = new ArrayList[2][7]; //Array de 2row 7column. Almacena nuestro ejército y ejército enemigo. 
	...
	private int[][] initialCostFleet; //Almacena el coste inicial de metal y deuterio de las flotas. Para saber las pérdidas en materiales de cada flota. 
	
	
	private int initialNumberUnitsPlanet, initialNumberUnitsEnemy; //Número de unidades iniciales de cada equipo. 
	
	private int[] wasteMetalDeuterium; //Num de residuos generados en la batalla, [0]metal, [1]deuterium

	
	private int[] enemyDrops; //Para generar reporte de batalla y calcular pérdida de material de cada equipo. 
	...
	//Por parámetro se pasarán las unidades del planeta y las unidades enemigas para iniciar los atributos y poder hacer la batalla. 
	public Battle(ArrayList<MilitaryUnit>[] planetArmy, ArrayList<MilitaryUnit>[] enemyArmy) {
		...
		//Añadir flotas a array bidimensional: 
		for(int i = 0; i < 2; i++) {
		...
		//Número de unidades iniciales de cada equipo:
		...
		initialArmies(); //Inicializa el array InitialArmies, para saber el número de cada tipo de flota al inicio del planeta y enemigo. 
	}	
		
		
		
	
	/**Método para empezar batalla.  */
	...
	/**Inicializa el array InitialArmies, para saber el número de cada tipo de flota al inicio del planeta y enemigo*/
	...
	/**Devuelve un array con el coste total de metal y deuterium de la flota que pasemos por parámetro. [0] = metal, [1] = deuterium*/
	...
	/** Almacenar número de unidades iniciales de cada equipo:*/
